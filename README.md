...
1) The "run_analysis.R"  script which outputs a textfile called "meandata.txt" that contains a "tidy" dataset which 
...
2) The "CodeBook.md" file provides a description of the data set in the "meandata.txt" file created by "run_analyis.R" (e.g. performed transformations, etc.).
